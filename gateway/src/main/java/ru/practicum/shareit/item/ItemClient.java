...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItem(ItemDto item, Long userId) {
        item.validateItemDto();
        return post("", userId, item);
    }

    public ResponseEntity<Object> updateItem(ItemDto item, Long userId) {
        return put("", userId, null, item);
    }
    ...
    public ResponseEntity<Object> getItemByIdWithComments(Long itemId, Long userId) {
